## [echarts](/advance/echarts)

- ### Function Introduction

  The data interface of echarts.js is integrated into R language and the data and visualization process are controlled
  by web components.

- ### Data Structure

  Data frame for different applications.
