## [nonegenome-go-enrichplot](/advance/nonegenome-go-enrichplot)

- ### Function Introduction

  GO enrichment and visualization for no-genome species GO annotation information and DEGs list.
