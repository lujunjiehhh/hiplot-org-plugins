## [bar-posneg](/advance/bar-posneg)

- ### Function Introduction

  Bar plot with positive and negtive value at different facet.

- ### Data Structure

  Data frame with csv format. Data with positive and negtive value both.
