## [refgenome-kegg-enrichplot](/advance/refgenome-kegg-enrichplot)

- ### Function Introduction

  KEGG enrichment and visualization for reference genome species KEGG annotation information and DEGs list.
