## [maf-oncoplots](/advance/maf-oncoplots)

- ### Function Introduction

  Mutation Annotation Format (MAF) Waterfall OncoPlot Online Customizing.

- ### Data Structure

  MAF file and clinical file.
...
- ### Reference Packages
  ...
  maftools: (Maintainer: Anand Mayakonda <anand_mt@hotmail.com>)
