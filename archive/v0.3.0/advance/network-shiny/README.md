## [network-shiny](/advance/network-shiny)

- ### Function Introduction

  The network application is used to visualize the interaction network of protein with protein.

- ### Data Structure

  Data frame.

  \<1st-col\>: (String) source node data.

  \<2nd-col\>: (String) target node data.
...
- ### Reference Packages
  ...
  network: (Maintainer: Carter T. Butts \<buttsc@uci.edu\>)
