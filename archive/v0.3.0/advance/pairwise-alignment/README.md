## [pairwise-alignment](/advance/pairwise-alignment)

- ### Function Introduction

  Pairwise alignment of two sequences. DNA, RNA and Amino Acid sequences are optional.

- ### Data Structure

  Two sequence of DNA, RNA or Amino Acid.
...
- ### Reference Packages
  ...
  Biostrings: (Maintainer: H. Pagès \<hpages@fredhutch.org\>)
