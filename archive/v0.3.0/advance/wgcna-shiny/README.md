## [wgcna-shiny](/advance/wgcna-shiny)

- ### Function Introduction

  WGCNA: Weighted Genes Correlation Network Analysis

- ### Data Structure

  Two tables.

  \<1st-table\>: genes expression matrix data.

  \<2nd-table\>: traits data.
...
- ### Reference Packages
  ...
  WGCNA: (Maintainer: Peter Langfelder \<Peter.Langfelder@gmail.com\>)
