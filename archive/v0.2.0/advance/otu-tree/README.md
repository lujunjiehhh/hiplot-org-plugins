## [otu-tree](/advance/otu-tree)

- ### Function Introduction

  The OTU data of microbes is visualized as taxonomy tree.
...
- ### Data Structure
  ...
  \<2nd-table\>: key nodes table.

  \<1st-col\>: (String) key nodes IDs.

  \<2nd-col\>: (String) colors for correspond nodes.
...
- ### Reference Packages
  ...
  microbiomeViz: (Maintainer: The package maintainer <yourself@somewhere.net>)
