## [ternary-diagram](/advance/ternary-diagram)

- ### Function Introduction

  Ternary diagram visualize three variables in one diagram.

- ### Data Structure

  Data frame.

  \<1st-col\>: (Numeric) data as x-axis.

  \<2nd-col\>: (Numeric) data as Y-axis.

  \<3rd-col\>: (Numeric) data as Z-axis.

  \<4th-col\>: (Numeric) value.

  \<5th-col\>: (String) groups name.
