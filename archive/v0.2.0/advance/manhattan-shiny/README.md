## [manhattan-shiny](/advance/manhattan-shiny)

- ### Function Introduction

  Manhattan diagram visualization for SNP data based on QQMan package and manhattan++ package.
...
- ### Reference Packages
  ...
  manhplot: (Maintainer: Chris Grace \<cgrace@well.ox.ac.uk\>)
