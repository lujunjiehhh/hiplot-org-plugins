...
- ### Function Introduction
  ...
  Based on a variety of clustering algorithms, the data are clustered and the clustering results are visualized.

- ### Data Structure

  Data frame.

  \<1st-col\>: (String) rows name.

  \<2nd-col\>~\<nth-col\>: (Numeric) variable.
...
- ### Reference Packages
  ...
  factoextra: (Maintainer: Alboukadel Kassambara \<alboukadel.kassambara@gmail.com\>)
